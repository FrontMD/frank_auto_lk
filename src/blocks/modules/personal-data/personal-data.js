    ...
    const contactLayout = `
                                <div class="pd-contact__header">
                                  ...
                                  <button class="pd-contact__remove" data-js="pdContactsRemove">
                                    <svg>
                                      <use xlink:href="${window.distPath}img/sprites/sprite.svg#urn"></use>
                                    </svg>
                                  </button>
                                </div>
                                <div class="pd-contact__fields">
                                      <div class="field "data-js="formField">
                                        <label>
                                          <input class="field__input" type="text" name="surname" placeholder="" required="" data-type="letters">
                                      ...
                                      <div class="field "data-js="formField">
                                        <label>
                                          <input class="field__input" type="text" name="name" placeholder="" required="" data-type="letters">
                                      ...
                                      <div class="field "data-js="formField">
                                        <label>
                                          <input class="field__input" type="text" name="last_name" placeholder="" data-type="letters">
                                      ...
                                      <div class="field "data-js="formField">
                                        <label>
                                          <input class="field__input" type="text" name="phone" placeholder="" required="" data-v-name="phone" data-type="phoneNumber">
